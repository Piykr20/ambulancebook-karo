...
<body>
    ...
    $query="select driver_name,driver_num,driver_num,driver_car,user_num,booking_id from booking_detail";
                ...
                <div class="row">
                    <div class="card clr" style="width: 11rem;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="experience-points"><i class="bi bi-phone"></i><h6>9876543210</h6>
                            </div>
                        </div>
                      </div>
                </div>
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact"
                                type="button" role="tab" aria-controls="contact" aria-selected="false">Notification</button>
                        </li>
                    </ul>
